...
<body>
    <div class="admin-login-container">
        ...
        <form id="adminLoginForm" action="../Controller/validacaoadmin.php" method="POST">
    ...
    <script>
        // Mostrar mensagens de erro/sucesso do PHP se existirem
        <?php if (isset($_SESSION['admin_error'])): ?>
            showError('<?php echo htmlspecialchars($_SESSION['admin_error']); ?>');
            <?php unset($_SESSION['admin_error']); ?>
        <?php endif; ?>
        
        <?php if (isset($_SESSION['admin_success'])): ?>
            showSuccess('<?php echo htmlspecialchars($_SESSION['admin_success']); ?>');
        ...
        document.getElementById('adminLoginForm').addEventListener('submit', function(e) {
            ...
            // O PHP fará a validação real no banco de dados
        });
