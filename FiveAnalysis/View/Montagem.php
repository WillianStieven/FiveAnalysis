...
<body>
  <header>
    ...
    <div class="icons">
      ...
      <a href="Carrinho.php" class="cart-link" style="position: relative; text-decoration: none; color: var(--text-primary); display: inline-block;">
        <i class="bi bi-cart2"></i>
        <span class="cart-badge" id="cartBadge" style="display: none; position: absolute; top: -8px; right: -8px; background: var(--primary-color); color: var(--text-primary); border-radius: 50%; width: 20px; height: 20px; align-items: center; justify-content: center; font-size: 12px; font-weight: 600; border: 2px solid var(--background-dark);">0</span>
      </a>
    </div>
  </header>
