...
function finalizarPedido() {
    ...
    // Salvar resumo no localStorage para uso posterior
    localStorage.setItem('pedido_resumo', JSON.stringify(resumo));
    
    // Mostrar confirmação
    carrinhoManager.mostrarNotificacao('Pedido finalizado com sucesso!', 'success');
    
    // Aqui você pode redirecionar para uma página de confirmação ou processar o pedido
    // Por enquanto, apenas limpar o carrinho após 2 segundos
    setTimeout(() => {
